...
import MobileBrand from "../../../models/electronics/mobile/mobile_brand_model.js";
import {uploadMobileBrandImage,deleteMobileBrandImage} from "../../../utils/electronics/mobile/mobileBrand.js";
...
const existing=await MobileBrand.findOne({name:new RegExp(`^${name.trim()}$`,"i")});
...
const brand=await MobileBrand.create({name:name.trim(),logoUrl});
